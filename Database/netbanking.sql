...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 08, 2013 at 04:37 AM
...
('516267', 98680, 'active', '2013-02-02', 'Current', 1000020.00),
('78312', 98683, 'active', '2013-02-09', 'Savings', 4239.00);
...
(98680, 'BOGC2345', 'Tom', 'Cruise', 'MI5', 'agent', 'dash', 'ACTIVE', 'Bangalore', 'KARNATAKA', 'INDIA', '2013-02-02', '2013-07-04 07:51:22'),
(98682, 'IB1232', 'Brad', 'Pitt', 'Cool', '12345', '123456', 'ACTIVE', 'London', 'EDGBASTON', 'ENGLAND', '2013-02-02', '2013-07-03 05:54:11'),
(98683, 'WB6357', 'Al', 'Pacino', 'Goldy', 'old', 'gold', 'ACTIVE', 'New York', 'MICHIGAN', 'USA', '2013-02-09', '2013-07-08 03:51:29');
...
CREATE TABLE IF NOT EXISTS `loan` (
  ...
  PRIMARY KEY (`loanid`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=56433 ;

--
-- Dumping data for table `loan`
--

INSERT INTO `loan` (`loanid`, `loantype`, `loanamt`, `customerid`, `interest`, `startdate`) VALUES
(56432, 'CAR', '34000', 98683, 30.00, '2013-07-02');
...
INSERT INTO `loanpayment` (`customerid`, `paymentid`, `loanid`, `amount`, `paymentdate`) VALUES
(98683, 3, 56432, 200, '2013-07-04 05:32:53');
...
CREATE TABLE IF NOT EXISTS `registered_payee` (
  ...
  `ifsccode` varchar(25) NOT NULL,
  PRIMARY KEY (`slno`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=98708 ;
...
(98707, 'Peter Parker', '8854632', 'CURRENT ACCOUNT', 'HDFC Bank', 'SM99999');
...
(4, '2013-07-04 06:57:32', 98683, 98680, 100, 'active'),
(5, '2013-07-04 06:58:41', 98683, 98682, 100, 'active'),
(8, '2013-07-04 07:21:11', 98683, 98680, 40, 'active'),
(9, '2013-07-04 07:25:06', 98683, 98680, 200, 'active'),
(10, '2013-07-04 07:27:36', 98683, 98680, 20, 'active');
